...
export const  BottomTabIcons = [
    {name:"Home",inactive:"https://img.icons8.com/windows/32/ffffff/home.png",active:"https://img.icons8.com/ios-filled/50/ffffff/home.png"},
    {name:"Search",active:"https://img.icons8.com/ios-filled/50/ffffff/search--v1.png",inactive:"https://img.icons8.com/ios/50/ffffff/search--v1.png"},
...
const Icon = ({icon})=>
{
    ...
    <TouchableOpacity onPress={()=>(setActiveTab(icon.name))}>
        <Image source={{ uri: activeTab===icon.name? icon.active:icon.inactive}} style={[styles.icon,icon.name==="profile"?styles.profile():null,activeTab==="profile" && icon.name==activeTab ?styles.profile(icon.name):null]} />
    </TouchableOpacity>
);}
